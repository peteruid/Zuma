//
//  ZumaInstallationPowerOffViewController.swift
//  Zuma
//
...
class ZumaInstallationFirstInstallViewController: UIViewController {
    ...
    @objc func buttonNormalTap(_ sender: UIGestureRecognizer){
        //print("Normal tap")
        self.performSegue(withIdentifier:"FirstInstallDoneSegue", sender: sender)
    }
